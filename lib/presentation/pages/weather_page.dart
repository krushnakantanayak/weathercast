...
import 'package:weather/presentation/okblock/okblock.dart';
        ...
        child: Column(
          ...
          children: [
            TextField(
              ...
              onChanged: (query) {
                context.read<WeatherBlock>().add(OnCityChanged(query));
              },
              onSubmitted: (value) {
                context.read<OkBloc>().add(OnTest());
              },
            ),
            const SizedBox(height: 32.0),

            // BlocBuilder<WeatherBlock, WeatherState>(builder: (context, state) {
            ...
            // }),
            // const SizedBox(height: 32.0),
            BlocBuilder<WeatherBlock, WeatherState>(
            ...
            // BlocBuilder<OkBloc, OkblocState>(
            //   builder: (context, state) {
